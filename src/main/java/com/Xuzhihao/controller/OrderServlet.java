...
import com.Xuzhihao.dao.OrderDao;
import com.Xuzhihao.model.Item;
import com.Xuzhihao.model.Order;
import com.Xuzhihao.model.Payment;
...
public class OrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String path="/WEB-INF/view/order.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(n>0){
            String path="/WEB-INF/view/orderSuccess.jsp";
            request.getRequestDispatcher(path).forward(request,response);
        }
    }
}
