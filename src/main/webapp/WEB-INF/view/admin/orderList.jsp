		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.Xuzhihao.model.Order o=(com.Xuzhihao.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.Xuzhihao.dao.UserDao userDao=new com.Xuzhihao.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.Xuzhihao.model.Payment.findByPaymentId(con,n);
						%>
